var rrwebPlayer = (function () {
	...
	***************************************************************************** */
	...
	const file = "src/Controller.html";
	...
	function create_if_block(component, ctx) {
		var div5, div3, span0, text0_value = formatTime(ctx.currentTime), text0, text1, div2, div0, text2, div1, text3, span1, text4_value = formatTime(ctx.meta.totalTime), text4, text5, div4, button, text6;
		...
		return {
			c: function create() {
				...
				span0.className = "rr-timeline__time svelte-omp6ou";
				addLoc(span0, file, 3, 4, 81);
				div0.className = "rr-progress__step svelte-omp6ou";
				setStyle(div0, "width", ctx.percentage);
				addLoc(div0, file, 9, 6, 284);
				div1.className = "rr-progress__handler svelte-omp6ou";
				setStyle(div1, "left", ctx.percentage);
				addLoc(div1, file, 10, 6, 365);
				addListener(div2, "click", click_handler);
				div2.className = "rr-progress svelte-omp6ou";
				toggleClass(div2, "disabled", ctx.isSkipping);
				addLoc(div2, file, 4, 4, 150);
				span1.className = "rr-timeline__time svelte-omp6ou";
				addLoc(span1, file, 16, 4, 491);
				div3.className = "rr-timeline svelte-omp6ou";
				addLoc(div3, file, 2, 2, 51);
				addListener(button, "click", click_handler_1);
				button.className = "svelte-omp6ou";
				addLoc(button, file, 19, 4, 608);
				div4.className = "rr-controller__btns svelte-omp6ou";
				addLoc(div4, file, 18, 2, 570);
				div5.className = "rr-controller svelte-omp6ou";
				addLoc(div5, file, 1, 0, 21);
			},
			...
			p: function update(changed, ctx) {
				if ((changed.currentTime) && text0_value !== (text0_value = formatTime(ctx.currentTime))) {
				...
				if ((changed.meta) && text4_value !== (text4_value = formatTime(ctx.meta.totalTime))) {
	...
	function create_main_fragment$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				text = createText("\n  ");
				if (if_block) if_block.c();
				div0.className = "rr-player__frame svelte-1ulpseq";
				div0.style.cssText = ctx.style;
				addLoc(div0, file$1, 1, 2, 59);
				div1.className = "rr-player svelte-1ulpseq";
